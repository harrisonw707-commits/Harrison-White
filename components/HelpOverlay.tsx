    ...
    <div className="fixed inset-0 z-[100] flex justify-end animate-in fade-in duration-300">
      ...
      <div className="relative w-full max-w-md bg-slate-900 border-l border-slate-800 shadow-2xl h-full flex flex-col animate-in slide-in-from-right duration-500">
        ...
        <div className="flex-grow overflow-y-auto p-8 space-y-10 custom-scrollbar">
          ...
          <section className="space-y-4">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Envision Paths uses your <strong className="text-slate-200">camera</strong> to analyze non-verbal cues. The AI observes your presence in real-time to provide feedback on professional appearance.
            </p>
            <div className="grid grid-cols-2 gap-3 mt-4">
               <div className="bg-slate-800/40 p-3 rounded-xl border border-slate-700">
                  <div className="text-[10px] font-black text-red-400 uppercase mb-1">Eye Contact</div>
                  <p className="text-[9px] text-slate-500">Maintains focus on the lens, projecting confidence.</p>
               </div>
               <div className="bg-slate-800/40 p-3 rounded-xl border border-slate-700">
                  <div className="text-[10px] font-black text-red-400 uppercase mb-1">Posture</div>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-red-600/10 p-5 rounded-2xl border border-red-500/20">
        ...
        <div className="p-6 border-t border-slate-800 bg-slate-900/50">
          <button 
            onClick={onClose}
            className="w-full py-4 bg-red-600 hover:bg-red-700 text-white rounded-2xl font-bold transition-all text-sm shadow-xl shadow-red-900/20"
          >
            Ready to Practice
          </button>
        </div>
